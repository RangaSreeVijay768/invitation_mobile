...
object PushConstants {
  ...
  const val AWS_PINPOINT_TITLE = "pinpoint.notification.title"
  const val AWS_PINPOINT_IMAGE_SMALL_ICON_URL = "pinpoint.notification.imageSmallIconUrl"
  const val AWS_PINPOINT_IMAGE_ICON_URL = "pinpoint.notification.imageIconUrl"
}
