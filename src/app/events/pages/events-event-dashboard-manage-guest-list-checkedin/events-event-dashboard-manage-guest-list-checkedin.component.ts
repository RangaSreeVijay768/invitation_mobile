...
@Component({
    selector: 'events-event-dashboard-manage-guest-list-checkedin',
    templateUrl: './events-event-dashboard-manage-guest-list-checkedin.component.html',
    styleUrls: ['./events-event-dashboard-manage-guest-list-checkedin.component.scss']
})
export class EventsEventDashboardManageGuestListCheckedinComponent extends PageComponent {
